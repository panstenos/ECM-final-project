...
# 125 "dc_motor.c"
    ...
    setMotorPWM(mL);
    setMotorPWM(mR);
    _delay((unsigned long)((137)*(64000000/4000.0)));
    }
    for(i=20;i>5;i-=5){
    (*mL).direction=0;
    (*mR).direction=1;
    ...
    setMotorPWM(mL);
    setMotorPWM(mR);
    _delay((unsigned long)((146)*(64000000/4000.0)));
    if(i==10){_delay((unsigned long)((350)*(64000000/4000.0)));}
    }
...
# 174 "dc_motor.c"
    ...
    setMotorPWM(mL);
    setMotorPWM(mR);
    _delay((unsigned long)((213)*(64000000/4000.0)));
    }
    for(i=20;i>5;i-=5){
    (*mL).direction=1;
    (*mR).direction=0;
    ...
    setMotorPWM(mL);
    setMotorPWM(mR);
    _delay((unsigned long)((216)*(64000000/4000.0)));
    if(i==10){_delay((unsigned long)((350)*(64000000/4000.0)));}
    }
}
