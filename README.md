...
We assume that you can compile the code and push it to the buggy

1. Push the code the buggy
2. Start the buggy
3. (Optionnal) To skip the calibration push RF2 : The robot is going to start moving.
4. To calibrate put the White sheet in front of the robot and push RF3 and wait for the calibration to end.
